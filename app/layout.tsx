...
export const metadata: Metadata = {
  ...
  description:
    "Pinjaman aman dipercaya hampir 30 juta pengguna, dengan 14 juta+ pencairan telah disalurkan, serta berizin dan diawasi selama 7 tahun. Download Adapundi sekarang!", // Deskripsi default
  ...
  openGraph: {
    ...
    siteName: "Adapundi",
    // Gambar, judul, dan deskripsi akan dispesifikkan per halaman
  },
  twitter: {
