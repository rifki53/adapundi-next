      ...
      <div className="mx-auto w-full max-w-6xl px-4 py-10 pt-28 sm:px-6 lg:px-8">
        <div className="flex w-full flex-col items-center md:flex-row md:items-start">
          ...
          <div className="flex w-full flex-col items-center justify-center p-4 text-center md:w-1/2 md:items-start md:p-8 md:text-left">
            <h1 className="mb-2 text-6xl font-bold text-[#FE812A] sm:text-7xl md:text-[12rem]">
              404
            </h1>
            ...
            <p className="mb-6 text-base text-gray-600 sm:text-lg">
              Maaf, halaman tidak dapat ditemukan. Periksa ulang alamat URL dan
              coba lagi. Atau klik tombol di bawah ini.
            </p>
            <Link
              href="/"
              className="w-full rounded-full bg-[#2ACF27] px-12 py-4 text-center text-xl font-bold text-white transition hover:bg-[#26b023] sm:w-fit"
            >
              Beranda
            </Link>
          </div>
